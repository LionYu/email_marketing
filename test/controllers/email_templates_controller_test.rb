...
class EmailTemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create email_template" do
    assert_difference("EmailTemplate.count") do
      post email_templates_url, params: { email_template: { content: @email_template.content, email_marketing_category_id: @email_template.email_marketing_category_id, name: @email_template.name, subject: @email_template.subject } }
    end
  ...
  test "should update email_template" do
    patch email_template_url(@email_template), params: { email_template: { content: @email_template.content, email_marketing_category_id: @email_template.email_marketing_category_id, name: @email_template.name, subject: @email_template.subject } }
